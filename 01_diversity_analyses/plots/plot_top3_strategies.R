# Plotting just the top 3 most used strategies 
plot_top3_strategies <- ggplot() +
  theme_classic() +
  geom_violin(data = top_strategies_main3, 
              ...
              trim = FALSE,
              scale = "count") +
  geom_point(data = top_strategies_main3, 
             aes(x = strategy_ll, 
                 y = age_exact),
  ...
  labs(x = "Predicted Strategy",
       y = "Age") +
  scale_x_discrete(limits=c("diverse","average","extreme")) +
  coord_flip() +
